...
@Component({
  selector: 'app-report',
  standalone: true,
  imports: [CommonModule, FormsModule, DateRangeFilterComponent, RmsCurrencyPipe, RmsDatePipe],
...
export class ReportComponent {
  ...
  // ⭐ TRIGGERED BY THE DATE RANGE FILTER (presets + custom range)
  ...
  this.dashboardService.getReportByRange(this.fromDate(), this.toDate()).subscribe({
